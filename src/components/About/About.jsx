      ...
      {loading ? (
        ...
        <>
          <div className={`${style.mainContainer} bg-white`}>
            <p className={`underline absolute text-xl text-black p-20`}>
              About
            </p>
                ...
                <table className={style.table}>
                  ...
                  <tr>
                    ...
                    <td>
                      <a
                        className={`hover:text-blue-600`}
                        href="mailto:kaungmyathun7@gmail.com"
                      >
                  ...
                  <tr>
                    <td colSpan="2">
                      <p>
                        Hello! I am{" "}
                        <span className={`font-bold`}>Kaung Myat Hun</span>.
                      </p>
                      <p>
                        I am Junior Frontend Web Developer with above 1 years
                        Experience Working with React JS .
                      </p>
                      <p>
                        I am interesting to challenge to get new experience with
                        Frontend developer.
                      </p>
                      <p>I also know some design flow.</p>
                      <p>
                        I have experience with projects such as e-commence, POS,
                        Blog, Landing, Admin Panel, Chatting App etc.
                      </p>
                      <p>
                        I have some experience with Next js and Typescript too.
                      </p>
            ...
            <div>
              <p
                className={`text-center text-2xl py-10 text-black select-none`}
              >
