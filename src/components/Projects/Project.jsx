  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <p className={`text-center text-4xl text-black font-bold mt-10`}>Latest Projects</p>
          <div className={`${styles.mainContainer}`}>
            <div className={`flex max-[820px]:flex-col flex-row justify-around items-center`}>
              <div
                className={`w-4/12 mx-20 max-[400px]:mx-0 max-[400px]:w-7/12 hover:text-blue-600 text-black`}
                ...
                />
                <p className={`text-2xl  text-center mt-20 max-[400px]:my-10 hover:cursor-pointer`}>
                  Chat Messenger
                </p>
              </div>
              <div
